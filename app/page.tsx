...
function NetworkingCard() {
  return (
    <div className="group relative bg-white border text-white shadow-sm rounded-xl overflow-hidden aspect-square h-[400px] transition-transform ease-in-out duration-1000 ">
      <div className="w-full h-[400px] rounded-xl overflow-hidden">
        <Image
          className="rounded-xl group-hover:blur-sm filter brightness-50 transform transition-transform ease-in-out duration-1000 group-hover:scale-105 group-hover:rotate-1 group-hover:translate-x-1 group-hover:translate-y-1"
          src="/network.jpg"
          alt="Image Description"
          layout="fill"
          objectFit="cover"
      ...
      <div className="absolute top-0 start-0 end-0">
        <div className="p-4 md:p-5 bg-gradient-to-b from-[#000000]">
          <h3 className="text-lg font-bold">Network</h3>
          <p className="mt-1">
            Some quick example text to build on the card title and make up the
            bulk of the cards content.
