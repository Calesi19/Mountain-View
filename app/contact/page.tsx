...
import { BiStoreAlt, BiEnvelope } from "react-icons/bi";
...
function ContactForm(): React.JSX.Element {
  return (
    <div className="mrx-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
          ...
          <div className="divide-y divide-gray-200">
            <div className="flex gap-x-7 py-6">
              <FaRegStar className="flex-shrink-0 size-6 mt-1.5 text-gray-800" />
              <div className="grow">
                <h3 className="font-semibold text-gray-800">
                  Join the Chamber
                </h3>
                <p className="mt-1 text-sm text-gray-500">
                  If you are interested in joining the chamber, please see our
                  membership page.
                </p>
                <a
            ...
            <div className="flex gap-x-7 py-6">
              <BiStoreAlt className="flex-shrink-0 size-6 mt-1.5 text-gray-800" />
              <div className="grow">
                <h3 className="font-semibold text-gray-800">
                  Connect with a Local Business
                </h3>
                <p className="mt-1 text-sm text-gray-500">
                  If you are looking to connect with a local business, please
            ...
            <div className=" flex gap-x-7 py-6">
              <PiChatsBold className="flex-shrink-0 size-6 mt-1.5 text-gray-800" />
              <div className="grow">
                <h3 className="font-semibold text-gray-800">Socials</h3>
                <p className="mt-1 text-sm text-gray-500">
                  You can also connect with us on social media to stay up to
                  date.
                </p>
                <a
                  className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800"
            ...
            <div className=" flex gap-x-7 py-6">
              <BiEnvelope className="flex-shrink-0 size-6 mt-1.5 text-gray-800" />
              <div className="grow">
                <h3 className="font-semibold text-gray-800 ">
                  Contact us by email
                </h3>
...
function GoogleMapEmbed() {
  return (
    <iframe
      className="w-full h-[400px] rounded-xl object-cover pt-32 container"
...
function LocationDetails() {
  return (
    <div className="flex items-center justify-evenly gap-4 container pt-16">
      <div>
      ...
      <div>
        ...
        <p className="mt-1 text-gray-600">
          ...
          <br /> Conferences every 2nd Wednesday
        </p>
      </div>
    </div>
  );
